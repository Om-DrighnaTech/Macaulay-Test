...
const crausalData = [
{ id: 1, image: curriculumImg1, heading: 'Management ', link: 'www.google.com' },
{ id: 2, image: curriculumImg2, heading: 'Management', link: 'www.google.com'},
{ id: 3, image: curriculumImg3, heading: 'Management', link: 'www.google.com' },
];
return (
<>
<Carousel>
      ...
      <div className="infra-title">
        <h2 className='infra-title-head'>Management</h2>
      </div>
</>
)
}
